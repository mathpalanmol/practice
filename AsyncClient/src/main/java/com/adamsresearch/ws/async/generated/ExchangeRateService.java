 ...
 * 
 */
@WebServiceClient(name = "ExchangeRateService", targetNamespace = "http://async.ws.adamsresearch.com/", wsdlLocation = "http://localhost:8282/exchangeRateService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8282/exchangeRateService?wsdl");
