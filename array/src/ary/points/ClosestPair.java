...
public class ClosestPair
{
  ...
  private static Pair divideAndConquer(List<? extends Point> pointsSortedByX, List<? extends Point> pointsSortedByY)
  {
    ...
    List<? extends Point> leftOfCenter = pointsSortedByX.subList(0, dividingIndex);//exclude mid.
    List<? extends Point> rightOfCenter = pointsSortedByX.subList(dividingIndex, numPoints);//mid and rest.
